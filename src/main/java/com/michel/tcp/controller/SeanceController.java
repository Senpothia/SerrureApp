...
public class SeanceController {
	...
	public String board(@PathVariable(name = "id") Integer id, Model model, HttpSession session) {
		...
		if (testUser(utilisateur)) {
			...
			Echantillon e2Proto = SerrureAppApplication.echantillons.get(1);
			...
			Echantillon e3Proto = SerrureAppApplication.echantillons.get(2);
			...
			EchsNew.add(ech1Base);
			EchsNew.add(ech2Base);
			EchsNew.add(ech3Base);
